...
> Codex/AGENTS.md target is **experimental**. The wiring is the same as
> for Claude Code; only the host file name differs. File a PR if you spot
> rough edges: <https://github.com/ayleen/triss-coworker>

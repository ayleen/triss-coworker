...
selected provider/model through the selected engine (setup once via
...
`--engine omp`). Thedefault opencode engine enforces a working deny-first bash allowlist; crush

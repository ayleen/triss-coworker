...
coder
  ...
  .option('--allow-unverified', 'OpenCode Go only: allow the built-in model fallback after a temporary network, HTTP 429, or HTTP 5xx catalogue failure (never bypasses 401/403, empty, or invalid responses)')
